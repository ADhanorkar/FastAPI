...
async def read_items(q: Annotated[Union[str, None], Query(min_length=3, 
                        max_length=50, pattern="^fixedquery$")]  = None):
    result = {"items": [{"item_id": "SB001"}, {"item_id": "SB002"}]}
...
# default anyway 🤷) and that we want to have additional validation for this value 
# (that's why we do this, to get the additional validation). 😎
